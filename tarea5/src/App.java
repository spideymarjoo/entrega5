...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        presidente presi1 = new presidente("Florentino Perez", fechanacimiento(1947, 3, 8), "Espania", "A12B", null);
        presidente presi2 = new presidente("Johan Laporta", fechanacimiento(1962, 6, 29), "Espania", "A23E", null);
        presidente presi3 = new presidente("Nasser Alkhela", fechanacimiento(1973, 11, 12), "Qatar", "A34C", null);
        presidente presi4 = new presidente("Fernando Cabada", fechanacimiento(1963, 5, 14), "Peru", "A56D", null);
        presidente presi5 = new presidente("Enrique Cerezo", fechanacimiento(1948, 2, 27), "Espania", "A78F", null);

        entrenador e1 = new entrenador("Hansi Flick", fechanacimiento(1965, 2, 24), "Alemania", formaciones.CUATRO_TRES_TRES, null);
        entrenador e2 = new entrenador("Carlo Ancelotti", fechanacimiento(1959, 6, 10), "Italia", formaciones.CINCO_TRES_DOS, null);
        entrenador e3 = new entrenador("Luis Martinez", fechanacimiento(1970, 6, 8), "Espania", formaciones.CUATRO_CUATRO_DOS, null);
        entrenador e4 = new entrenador("Nestor Gorosito", fechanacimiento(1964, 5, 14), "Argentina", formaciones.CUATRO_CINCO_UNO, null);
        entrenador e5 = new entrenador("Xolo Simeone", fechanacimiento(1970, 04, 28), "Argentina", formaciones.CINCO_TRES_DOS, null);
        ...
        // --------------------------------------Prueba de nuevo jugador y borrar
        // jugador------------------------------------------
        ...
        System.out.println("Numero de trabajadores totales " + trabajador.gettrabajadoresTotales());
