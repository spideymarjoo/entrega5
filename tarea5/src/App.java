...
public class App {
        ...
        public static void main(String[] args) throws Exception {
                ...
                presidente presi1 = new presidente("Florentino Perez", fechanacimiento(0, 0, 0), "Venezuela","A12B", null);
                presidente presi2 = new presidente("Johan Laporta",fechanacimiento(0, 0, 0), "Venezuela","A23E", null);
                presidente presi3 = new presidente("Nasser Alkhela",fechanacimiento(0, 0, 0), "Venezuela","A34C", null);
                presidente presi4 = new presidente("Fernando Cabada",fechanacimiento(0, 0, 0), "Venezuela","A56D", null);
                presidente presi5 = new presidente("Enrique Cerezo",fechanacimiento(0, 0, 0), "Venezuela","A78F", null);

                entrenador e1 = new entrenador("Hansi Flick", fechanacimiento(2003, 2, 2), "Venezuela", formaciones.CUATRO_TRES_TRES, null);
                entrenador e2 = new entrenador("Carlo Ancelotti",fechanacimiento(0, 0, 0), "Venezuela" ,formaciones.CINCO_TRES_DOS, null);
                entrenador e3 = new entrenador("Luis Marinez",fechanacimiento(0, 0, 0), "Venezuela" ,formaciones.CUATRO_CUATRO_DOS, null);
                entrenador e4 = new entrenador("Nestor Gorosito",fechanacimiento(0, 0, 0), "Venezuela",formaciones.CUATRO_CINCO_UNO, null);
                entrenador e5 = new entrenador("Xolo Simeone",fechanacimiento(0, 0, 0), "Venezuela",formaciones.CINCO_TRES_DOS, null);
